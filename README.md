...
<!-- FLEET-BADGES:BEGIN -->
[![CI](https://github.com/tzervas/mycelium-build/actions/workflows/fleet-ci.yml/badge.svg?branch=main)](https://github.com/tzervas/mycelium-build/actions/workflows/fleet-ci.yml?query=branch%3Amain)
[![Security](https://github.com/tzervas/mycelium-build/actions/workflows/fleet-security.yml/badge.svg?branch=main)](https://github.com/tzervas/mycelium-build/actions/workflows/fleet-security.yml?query=branch%3Amain)
...
| **Source paths** | crates/mycelium-build |
| **License** | MIT |
