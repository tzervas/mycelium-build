# Gap status — `mycelium-build`

| Field | Value |
|-------|--------|
| **Component** | `mycelium-build` |
| **Role** | Stable-component build layer |
| **Date** | 2026-07-29 |
...
| **Native twin** | `tzervas/mycelium-build-myc` under [mycelium-lang-myc](https://github.com/tzervas/mycelium-lang-myc) |
| **Local gap notes** | none |
| **Related issues** | Spore/build certs; native binary later |
